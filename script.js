"use strict";
const animalContainer = document.getElementById("selectYourAnimal");
const selectContainer = document.getElementById("selectContainer");
const mainGameContainer = document.getElementById("gameContainer");
const startGameButton = document.getElementById("startGame");
const animalIconElem = document.getElementById("animalIconElem");
...
function selectAnimal(animalName, animalClass, element) {
...
function animateSprite(className) {
    if (spriteIntervals[className]) {
        clearInterval(spriteIntervals[className]);
...
function startMovement() {
    const road = document.getElementById('animalRoad');
